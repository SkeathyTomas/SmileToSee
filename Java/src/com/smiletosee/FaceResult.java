...
public class FaceResult {
	...
	static {
		keyWordDict = new Hashtable<String, FaceResult.JsonType>();
		...
		keyWordDict.put("result", JsonType.ARRAY);

		keyWordDict.put("faces", JsonType.ARRAY);
		keyWordDict.put("landmark",JsonType.JSON);
	 ...
	 */
	public FaceResult(Object json, int httpResponseCode) {
		this.json = json;
		this.type = JsonType.JSON;
	 ...
	 * @param httpResponseCode
	 */
	public FaceResult(Object json, JsonType type, int httpResponseCode) {
		this.json = json;
		this.type = type;
		this.httpResponseCode = httpResponseCode;
	}
	 ...
	 * @throws FaceppParseException
	 */
	public FaceResult get(int index) throws FaceppParseException {
		...
		try {
			return new FaceResult( ((JSONArray)json).getJSONObject(index), JsonType.JSON, httpResponseCode);
		} catch (JSONException e) {	
	 ...
	 * @throws FaceppParseException
	 */
	public FaceResult get(String key) throws FaceppParseException {
		...
		switch (returnType) {
		case INT:
			return new FaceResult( getInt(key), JsonType.INT, httpResponseCode);
		case DOUBLE:
			return new FaceResult( getDouble(key), JsonType.DOUBLE, httpResponseCode);
		case BOOL:
			return new FaceResult( getBoolean(key), JsonType.BOOL, httpResponseCode);
		case STRING:
			return new FaceResult( getString(key), JsonType.STRING, httpResponseCode);
		case ARRAY:
			return new FaceResult( getArray(key), JsonType.ARRAY, httpResponseCode);
		case JSON:
			return new FaceResult( getJson(key), JsonType.JSON, httpResponseCode);
		default:
	 ...
	 * @throws FaceppParseException
	 */
	public FaceResult get(String key, JsonType type) throws FaceppParseException {
		if (this.type != JsonType.JSON) {
			throw new FaceppParseException("( " + json.toString() + " ) is not json string.");
		}
